...
<c:if test="${all == 'select'}">
    <h2 style="text-align: center"> ${messages.firstName} ${messages.lastName}</h2>
    <div class="row">
        <c:forEach var="message" items="${messages.messageDtos}">
                ...
                <form action="/login/roleController/${role.id}"  <c:url value="/users"/> >
                    <div class="card">
                        <div class="card-body pl-0 pr-0 pt-4 pb-4" style="text-align: center">
                            ...
                            <h8 style="text-align: right">${message.time}</h8>
